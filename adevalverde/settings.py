"""
Django settings for adevalverde project.
...
BASE_URL = 'https://adelavalverde.info'
...
WSGI_APPLICATION = 'adevalverde.wsgi.application'
...
GOOGLE_SERVICE_ACCOUNT_FILE = os.path.join(BASE_DIR, 'calendars', 'service_account.json')
